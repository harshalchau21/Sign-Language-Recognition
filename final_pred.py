...
class Application:
    ...
    def __init__(self):
        ...
        self.model = load_model(r'C:\Users\91906\Desktop\Sign-Language-Recognition\my_model.h5')
        ...
        try:
            ...
            if cv2image.any:
                ...
                if hands:
                 ...
                 # No valid hand detected, skip this frame
                  return
                 img_h, img_w = cv2image_copy.shape[:2]
                 y1 = max(0, y - offset)
